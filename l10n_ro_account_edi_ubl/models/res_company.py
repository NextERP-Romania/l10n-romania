...
class ResCompany(models.Model):
    ...
    def _l10n_ro_create_anaf_efactura(self):
        ...
        ro_companies = self.search([]).filtered(
            lambda c: c.country_id.code == "RO" and c.l10n_ro_account_anaf_sync_id
        )
        ...
        for company in ro_companies:
            ...
            for message in company_messages:
                invoice = move_obj.search([("l10n_ro_edi_download", "=", message.get("id"))])
                if not invoice:
                    ...
                    new_invoice.l10n_ro_download_zip_anaf(company.l10n_ro_account_anaf_sync_id)
